...
while running:
    ...
    if (running == True) and (display_now == mode1):
        ...
        while (loop):
            ...
            while question_number <= quenum:
                ...
                textdraw(("Question " + str(question_number)), 65, black, 25)
                ...
                customtextdraw("Answering:", (50,600), white, 25)
                customtextdraw("Player 1", (200,600), gray, 25)
                customtextdraw("Player 2", (400,600), gray, 25)
                customtextdraw("Player 3", (600,600), gray, 25)
                customtextdraw("Player 4", (800,600), gray, 25)
                ...
                #PLAYER 1
                while (loop2):
                    customtextdraw("Player 1", (200,600), green, 25)
                    customtextdraw("Player 2", (400,600), gray, 25)
                    customtextdraw("Player 3", (600,600), gray, 25)
                    customtextdraw("Player 4", (800,600), gray, 25)
                    pygame.display.flip()
                ...
                while (loop3):
                    customtextdraw("Player 1", (200,600), gray, 25)
                    customtextdraw("Player 2", (400,600), green, 25)
                    customtextdraw("Player 3", (600,600), gray, 25)
                    customtextdraw("Player 4", (800,600), gray, 25)
                    pygame.display.flip()
                ...
                while (loop4):
                    customtextdraw("Player 1", (200,600), gray, 25)
                    customtextdraw("Player 2", (400,600), gray, 25)
                    customtextdraw("Player 3", (600,600), green, 25)
                    customtextdraw("Player 4", (800,600), gray, 25)
                    pygame.display.flip()
                ...
                while (loop5):
                    ...
                    customtextdraw("Player 2", (400,600), gray, 25)
                    customtextdraw("Player 3", (600,600), gray, 25)
                    customtextdraw("Player 4", (800,600), green, 25)
                    pygame.display.flip()
    ...
    if (running == True) and (display_now == results):
        ...
        def scoring(x):
            scr = str(scores[x][0]) + "    " + str(scores[x][1]) + " points"
            return scr
        
        results = textdraw("Results", 100, white, 45)
        ...
        quit = textdraw("back to menu", 650, red, 25)
